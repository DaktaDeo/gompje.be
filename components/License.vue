<template>
  ...
  >
    ...
    <a
      ...
      class="inline-flex justify-center space-x-2 hover:text-gray-500"
      ><span class="underline">CC BY-SA 4.0</span>

      <svg
        class="h-5 w-5 inline-svg fill-current ml-2"
      ...
      <svg
        class="h-5 w-5 inline-svg fill-current"
        xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink"
        x="0px"
        y="0px"
